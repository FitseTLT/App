...
describe('actions/Report', () => {
    ...
    it('should create new report and "create report" quick action, when createNewReport gets called', async () => {
        ...
        mockFetchData.pause();
        const {reportID} = Report.createNewReport({accountID}, true, false, policy, [CONST.BETAS.ALL], formatPhoneNumber);
    ...
    it('should set hasOnceLoadedReportActions for parent report metadata when creating a new report', async () => {
        ...
        mockFetchData.pause();
        Report.createNewReport({accountID}, true, false, policy, [CONST.BETAS.ALL], formatPhoneNumber);
        const parentReport = ReportUtils.getPolicyExpenseChat(accountID, policyID);
    ...
    it('should create the empty report with draft status if submission is instant with approval disabled', async () => {
        ...
        // When create new report
        const optimisticReportData = Report.createNewReport({accountID}, true, false, policy, [CONST.BETAS.ALL], formatPhoneNumber);
